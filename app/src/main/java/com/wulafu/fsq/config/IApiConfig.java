...
public interface IApiConfig {
   ...
   * API地址
   */
  String BASE_URL = BuildConfig.DEBUG ? SharedPreferenceHelper.getEnvUrl()
      : WApp.mContext.getString(R.string.abc_action_bar_home_description);
  /**
   * H5地址
   */
  String H5_BASE_URL = WApp.mContext.getString(R.string.abc_action_bar_home_description);
  /**
   * 每页需要加载的个数
   */
  int PAGESIZE = 10;
   ...
   * 社区视频详情
   */
  String COMMUNITY_VIDEO_DETAIL = "communityApi/getVideoDetail.htm";

  /**
   * 社区音频详情
   */
  String COMMUNITY_AUDIO_DETAIL = "communityApi/getAudioDetail.htm";
   ...
   * 清空我的所有文章的所有评论列表
   */
  String COMMUNITY_COMMENT_CLEAR_COMMENT = "communityApi/emptyComment.htm";
  /**
   * 发送邀请接口
   */
  String SEND_SMS = "book/search";
   ...
   * 首页获取达人列表接口
   */
  String ADVERT_GET_EXPERTS="advertApi/getExperts.htm";
  /**
   * 个人中心我的足迹 列表接口
   */
  String COMMUNITY_GETFOOTPRINTLIST_LIST = "communityApi/getFootPrintList.htm";
}
